...
{
	uint8_t type; ///< type of requested/acknowledged data (as defined in enum DATA_TYPES)
 ...
 *
 * @param type type of requested/acknowledged data (as defined in enum DATA_TYPES)
...
static inline uint16_t mavlink_msg_data_transmission_handshake_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t type, uint32_t size, uint8_t packets, uint8_t payload, uint8_t jpg_quality)
{
	...
	i += put_uint8_t_by_index(type, i, msg->payload); //type of requested/acknowledged data (as defined in enum DATA_TYPES)
...
static inline void mavlink_msg_data_transmission_handshake_send(mavlink_channel_t chan, uint8_t type, uint32_t size, uint8_t packets, uint8_t payload, uint8_t jpg_quality)
{
	...
	mavlink_msg_data_transmission_handshake_pack(mavlink_system.sysid, mavlink_system.compid, &msg, type, size, packets, payload, jpg_quality);
 ...
 *
 * @return type of requested/acknowledged data (as defined in enum DATA_TYPES)
 */
