...
#define MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA 49
 ...
 */
static inline uint16_t mavlink_msg_safety_set_allowed_area_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint8_t type, float x1, float y1, float z1, float x2, float y2, float z2)
{
...
{
	return mavlink_msg_safety_set_allowed_area_pack(system_id, component_id, msg, safety_set_allowed_area->target_system, safety_set_allowed_area->target_component, safety_set_allowed_area->type, safety_set_allowed_area->x1, safety_set_allowed_area->y1, safety_set_allowed_area->z1, safety_set_allowed_area->x2, safety_set_allowed_area->y2, safety_set_allowed_area->z2);
}

#ifdef MAVLINK_USE_CONVENIENCE_FUNCTIONS

static inline void mavlink_msg_safety_set_allowed_area_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t type, float x1, float y1, float z1, float x2, float y2, float z2)
{
	mavlink_message_t msg;
	mavlink_msg_safety_set_allowed_area_pack(mavlink_system.sysid, mavlink_system.compid, &msg, target_system, target_component, type, x1, y1, z1, x2, y2, z2);
...
/**
 * @brief Get field x1 from safety_set_allowed_area message
 *
 * @return x position 1
 */
static inline float mavlink_msg_safety_set_allowed_area_get_x1(const mavlink_message_t* msg)
{
	generic_32bit r;
...
/**
 * @brief Get field y1 from safety_set_allowed_area message
 *
 * @return y position 1
 */
static inline float mavlink_msg_safety_set_allowed_area_get_y1(const mavlink_message_t* msg)
{
	generic_32bit r;
...
/**
 * @brief Get field z1 from safety_set_allowed_area message
 *
 * @return z position 1
 */
static inline float mavlink_msg_safety_set_allowed_area_get_z1(const mavlink_message_t* msg)
{
	generic_32bit r;
...
/**
 * @brief Get field x2 from safety_set_allowed_area message
 *
 * @return x position 2
 */
static inline float mavlink_msg_safety_set_allowed_area_get_x2(const mavlink_message_t* msg)
{
	generic_32bit r;
...
/**
 * @brief Get field y2 from safety_set_allowed_area message
 *
 * @return y position 2
 */
static inline float mavlink_msg_safety_set_allowed_area_get_y2(const mavlink_message_t* msg)
{
	generic_32bit r;
...
/**
 * @brief Get field z2 from safety_set_allowed_area message
 *
 * @return z position 2
 */
static inline float mavlink_msg_safety_set_allowed_area_get_z2(const mavlink_message_t* msg)
{
	generic_32bit r;
...
static inline void mavlink_msg_safety_set_allowed_area_decode(const mavlink_message_t* msg, mavlink_safety_set_allowed_area_t* safety_set_allowed_area)
{
	...
	safety_set_allowed_area->type = mavlink_msg_safety_set_allowed_area_get_type(msg);
	safety_set_allowed_area->x1 = mavlink_msg_safety_set_allowed_area_get_x1(msg);
	safety_set_allowed_area->y1 = mavlink_msg_safety_set_allowed_area_get_y1(msg);
	safety_set_allowed_area->z1 = mavlink_msg_safety_set_allowed_area_get_z1(msg);
	safety_set_allowed_area->x2 = mavlink_msg_safety_set_allowed_area_get_x2(msg);
	safety_set_allowed_area->y2 = mavlink_msg_safety_set_allowed_area_get_y2(msg);
	safety_set_allowed_area->z2 = mavlink_msg_safety_set_allowed_area_get_z2(msg);
}
