...
#define MAVLINK_MSG_ID_MANUAL_CONTROL 50
 ...
 */
static inline uint16_t message_manual_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
...
static inline uint16_t message_manual_control_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const manual_control_t* manual_control)
{
	return message_manual_control_pack(system_id, component_id, msg, manual_control->target, manual_control->roll, manual_control->pitch, manual_control->yaw, manual_control->thrust, manual_control->roll_manual, manual_control->pitch_manual, manual_control->yaw_manual, manual_control->thrust_manual);
}
...
static inline void message_manual_control_send(mavlink_channel_t chan, uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
	mavlink_message_t msg;
	message_manual_control_pack(global_data.param[PARAM_SYSTEM_ID], global_data.param[PARAM_COMPONENT_ID], &msg, target, roll, pitch, yaw, thrust, roll_manual, pitch_manual, yaw_manual, thrust_manual);
 ...
 */
static inline uint8_t message_manual_control_get_target(const mavlink_message_t* msg)
{
 ...
 * @return roll
 */
static inline float message_manual_control_get_roll(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return pitch
 */
static inline float message_manual_control_get_pitch(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return yaw
 */
static inline float message_manual_control_get_yaw(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return thrust
 */
static inline float message_manual_control_get_thrust(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static inline uint8_t message_manual_control_get_roll_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_manual_control_get_pitch_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_manual_control_get_yaw_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_manual_control_get_thrust_manual(const mavlink_message_t* msg)
{
...
static inline void message_manual_control_decode(const mavlink_message_t* msg, manual_control_t* manual_control)
{
	manual_control->target = message_manual_control_get_target(msg);
	manual_control->roll = message_manual_control_get_roll(msg);
	manual_control->pitch = message_manual_control_get_pitch(msg);
	manual_control->yaw = message_manual_control_get_yaw(msg);
	manual_control->thrust = message_manual_control_get_thrust(msg);
	manual_control->roll_manual = message_manual_control_get_roll_manual(msg);
	manual_control->pitch_manual = message_manual_control_get_pitch_manual(msg);
	manual_control->yaw_manual = message_manual_control_get_yaw_manual(msg);
	manual_control->thrust_manual = message_manual_control_get_thrust_manual(msg);
}
