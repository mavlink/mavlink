 ...
 */
static inline uint16_t message_raw_aux_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int16_t baro)
{
	...
	i += put_int16_t_by_index(baro, i, msg->payload); //Barometric pressure (hecto Pascal)
...
static inline void message_raw_aux_send(mavlink_channel_t chan, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int16_t baro)
{
 ...
 */
static inline uint16_t message_raw_aux_get_adc1(const mavlink_message_t* msg)
{
	generic_16bit r;
	r.b[1] = (msg->payload)[0];
	r.b[0] = (msg->payload)[1];
 ...
 */
static inline uint16_t message_raw_aux_get_adc2(const mavlink_message_t* msg)
{
	generic_16bit r;
 ...
 */
static inline uint16_t message_raw_aux_get_adc3(const mavlink_message_t* msg)
{
	generic_16bit r;
 ...
 */
static inline uint16_t message_raw_aux_get_adc4(const mavlink_message_t* msg)
{
	generic_16bit r;
 ...
 */
static inline uint16_t message_raw_aux_get_vbat(const mavlink_message_t* msg)
{
	generic_16bit r;
 ...
 */
static inline int16_t message_raw_aux_get_temp(const mavlink_message_t* msg)
{
	generic_16bit r;
 ...
 */
static inline int16_t message_raw_aux_get_baro(const mavlink_message_t* msg)
{
	generic_16bit r;
	r.b[1] = (msg->payload+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(int16_t))[0];
	r.b[0] = (msg->payload+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(uint16_t)+sizeof(int16_t))[1];
	return (int16_t)r.s;
}
