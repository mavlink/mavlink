...
#define MAVLINK_MSG_ID_ATTITUDE_CONTROL 51
 ...
 */
static inline uint16_t message_attitude_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
...
static inline uint16_t message_attitude_control_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const attitude_control_t* attitude_control)
{
	return message_attitude_control_pack(system_id, component_id, msg, attitude_control->target, attitude_control->roll, attitude_control->pitch, attitude_control->yaw, attitude_control->thrust, attitude_control->roll_manual, attitude_control->pitch_manual, attitude_control->yaw_manual, attitude_control->thrust_manual);
}
...
static inline void message_attitude_control_send(mavlink_channel_t chan, uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
	mavlink_message_t msg;
	message_attitude_control_pack(global_data.param[PARAM_SYSTEM_ID], global_data.param[PARAM_COMPONENT_ID], &msg, target, roll, pitch, yaw, thrust, roll_manual, pitch_manual, yaw_manual, thrust_manual);
 ...
 */
static inline uint8_t message_attitude_control_get_target(const mavlink_message_t* msg)
{
 ...
 * @return roll
 */
static inline float message_attitude_control_get_roll(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return pitch
 */
static inline float message_attitude_control_get_pitch(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return yaw
 */
static inline float message_attitude_control_get_yaw(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return thrust
 */
static inline float message_attitude_control_get_thrust(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static inline uint8_t message_attitude_control_get_roll_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_attitude_control_get_pitch_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_attitude_control_get_yaw_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t message_attitude_control_get_thrust_manual(const mavlink_message_t* msg)
{
...
static inline void message_attitude_control_decode(const mavlink_message_t* msg, attitude_control_t* attitude_control)
{
	attitude_control->target = message_attitude_control_get_target(msg);
	attitude_control->roll = message_attitude_control_get_roll(msg);
	attitude_control->pitch = message_attitude_control_get_pitch(msg);
	attitude_control->yaw = message_attitude_control_get_yaw(msg);
	attitude_control->thrust = message_attitude_control_get_thrust(msg);
	attitude_control->roll_manual = message_attitude_control_get_roll_manual(msg);
	attitude_control->pitch_manual = message_attitude_control_get_pitch_manual(msg);
	attitude_control->yaw_manual = message_attitude_control_get_yaw_manual(msg);
	attitude_control->thrust_manual = message_attitude_control_get_thrust_manual(msg);
}
