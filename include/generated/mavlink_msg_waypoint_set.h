 ...
 */
static inline uint16_t mavlink_msg_waypoint_set_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t type, float orbit, uint8_t current, float x, float y, float z, float yaw, uint16_t autocontinue)
{
...
static inline void mavlink_msg_waypoint_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t type, float orbit, uint8_t current, float x, float y, float z, float yaw, uint16_t autocontinue)
{
