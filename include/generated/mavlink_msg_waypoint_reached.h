...
#define MAVLINK_MSG_ID_WAYPOINT_REACHED 98
 ...
 */
static inline uint16_t mavlink_msg_waypoint_reached_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint16_t id, uint16_t priority, float x, float y, float z, float yaw, uint16_t autocontinue)
{
...
{
	return mavlink_msg_waypoint_reached_pack(system_id, component_id, msg, waypoint_reached->target_system, waypoint_reached->target_component, waypoint_reached->id, waypoint_reached->priority, waypoint_reached->x, waypoint_reached->y, waypoint_reached->z, waypoint_reached->yaw, waypoint_reached->autocontinue);
}

#ifdef MAVLINK_USE_CONVENIENCE_FUNCTIONS

static inline void mavlink_msg_waypoint_reached_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t id, uint16_t priority, float x, float y, float z, float yaw, uint16_t autocontinue)
{
	mavlink_message_t msg;
	mavlink_msg_waypoint_reached_pack(mavlink_system.sysid, mavlink_system.compid, &msg, target_system, target_component, id, priority, x, y, z, yaw, autocontinue);
