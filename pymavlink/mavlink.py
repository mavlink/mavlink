...
class MAVLink_radio_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 213, struct.pack('>BBHHHH', self.rssi, self.remrssi, self.rxerrors, self.serrors, self.fixed, self.txbuf))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_RADIO : ( '>BBHHHH', MAVLink_radio_message, [0, 1, 2, 3, 4, 5], 213 ),
