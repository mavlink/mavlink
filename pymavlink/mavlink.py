...
class MAVLink_radio_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 143, struct.pack('>BBBHHH', self.rssi, self.remrssi, self.txbuf, self.rxerrors, self.serrors, self.fixed))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_RADIO : ( '>BBBHHH', MAVLink_radio_message, [0, 1, 2, 3, 4, 5], 143 ),
