...
```javascript
var mavlink = require('mavlink_implementation'), // requires Underscore.js, can use Winston for logging
	net = require('net');
...
Ideally, this would blorp out an NPM module so a client can just 'npm install mavlink.'  Not ready for that yet.
