...
gps_fields = ['GPS.Lat', 'GPS.Lon']
gps_data = {gps_fields[0]: None, gps_fields[1]: None}
...
def add_data(t, msg, vars):
    ...
    for n,o in gps_data.items():
        if o == None:
            gps_measurement_ready = False
    if gps_measurement_ready:
        add_kml(gps_data)
        gps_data = {n: None for n in gps_data} #reset gps_data
...
if __name__ == '__main__':
    ...
    parser.add_option("-o",dest="filename_out", default="mavkml.kml", help="ouput filename")
