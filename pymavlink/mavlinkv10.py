...
class MAVLink_radio_message(MAVLink_message):
        ...
        '''
        def __init__(self, rssi, remrssi, txbuf, rxerrors, serrors, fixed):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_RADIO, 'RADIO')
                self._fieldnames = ['rssi', 'remrssi', 'txbuf', 'rxerrors', 'serrors', 'fixed']
                self.rssi = rssi
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 244, struct.pack('<HHHBBB', self.rxerrors, self.serrors, self.fixed, self.rssi, self.remrssi, self.txbuf))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_RADIO : ( '<HHHBBB', MAVLink_radio_message, [3, 4, 5, 0, 1, 2], 244 ),
...
class MAVLink(object):
        ...
        def radio_encode(self, rssi, remrssi, txbuf, rxerrors, serrors, fixed):
                '''
                Status generated by radio
                ...
                '''
                msg = MAVLink_radio_message(rssi, remrssi, txbuf, rxerrors, serrors, fixed)
                msg.pack(self)
                return msg
            
        def radio_send(self, rssi, remrssi, txbuf, rxerrors, serrors, fixed):
                '''
                Status generated by radio
                ...
                '''
                return self.send(self.radio_encode(rssi, remrssi, txbuf, rxerrors, serrors, fixed))
