 ...
 **/
static inline void crcAccumulate(uint8_t data, uint16_t *crcAccum)
{
 ...
 */
static inline void crcInit(uint16_t* crcAccum)
{
 ...
 **/
static inline uint16_t crcCalculate(uint8_t* pBuffer, int length)
{
