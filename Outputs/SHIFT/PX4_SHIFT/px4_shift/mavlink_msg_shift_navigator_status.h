...
#define MAVLINK_MSG_ID_SHIFT_NAVIGATOR_STATUS_CRC 193
#define MAVLINK_MSG_ID_565_CRC 193
...
#define MAVLINK_MESSAGE_INFO_SHIFT_NAVIGATOR_STATUS { \
    ...
    7, \
    {  { "currentPathIndex", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_shift_navigator_status_t, currentPathIndex) }, \
         { "currentPointIndex", NULL, MAVLINK_TYPE_UINT16_T, 0, 2, offsetof(mavlink_shift_navigator_status_t, currentPointIndex) }, \
...
{
    return mavlink_msg_shift_navigator_status_pack(system_id, component_id, msg, shift_navigator_status->currentPathIndex, shift_navigator_status->currentPointIndex, shift_navigator_status->batteryRemaining, shift_navigator_status->navigatorMode, shift_navigator_status->navigatorSubMode, shift_navigator_status->objectMode, shift_navigator_status->detailField);
}
...
{
    return mavlink_msg_shift_navigator_status_pack_chan(system_id, component_id, chan, msg, shift_navigator_status->currentPathIndex, shift_navigator_status->currentPointIndex, shift_navigator_status->batteryRemaining, shift_navigator_status->navigatorMode, shift_navigator_status->navigatorSubMode, shift_navigator_status->objectMode, shift_navigator_status->detailField);
}
...
static inline void mavlink_msg_shift_navigator_status_send(mavlink_channel_t chan, uint16_t currentPathIndex, uint16_t currentPointIndex, uint8_t batteryRemaining, uint8_t navigatorMode, uint8_t navigatorSubMode, uint8_t objectMode, uint8_t detailField)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SHIFT_NAVIGATOR_STATUS_LEN];
    _mav_put_uint16_t(buf, 0, currentPathIndex);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_shift_navigator_status_send(chan, shift_navigator_status->currentPathIndex, shift_navigator_status->currentPointIndex, shift_navigator_status->batteryRemaining, shift_navigator_status->navigatorMode, shift_navigator_status->navigatorSubMode, shift_navigator_status->objectMode, shift_navigator_status->detailField);
#else
 ...
 */
static inline void mavlink_msg_shift_navigator_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t currentPathIndex, uint16_t currentPointIndex, uint8_t batteryRemaining, uint8_t navigatorMode, uint8_t navigatorSubMode, uint8_t objectMode, uint8_t detailField)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field currentPathIndex from shift_navigator_status message
 *
 * @return The current PathIndex traveling
 */
static inline uint16_t mavlink_msg_shift_navigator_status_get_currentPathIndex(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  0);
}

/**
 * @brief Get field currentPointIndex from shift_navigator_status message
 *
 * @return The current PointIndex traveling
 */
static inline uint16_t mavlink_msg_shift_navigator_status_get_currentPointIndex(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    shift_navigator_status->currentPathIndex = mavlink_msg_shift_navigator_status_get_currentPathIndex(msg);
    shift_navigator_status->currentPointIndex = mavlink_msg_shift_navigator_status_get_currentPointIndex(msg);
