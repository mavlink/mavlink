...
typedef struct __mavlink_shift_navigator_point_t {
 ...
 float duration; /*< duration to reach this point(x,y,z)*/
...
#define MAVLINK_MSG_ID_SHIFT_NAVIGATOR_POINT_CRC 74
#define MAVLINK_MSG_ID_560_CRC 74
 ...
 * @param duration duration to reach this point(x,y,z)
...
static inline uint16_t mavlink_msg_shift_navigator_point_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t pathIndex, uint16_t pointIndex, float positionX, float positionY, float positionZ, float positionRoll, float positionPitch, float positionYaw, float duration, uint8_t yawBehaviour, uint8_t type)
{
...
{
    return mavlink_msg_shift_navigator_point_pack_chan(system_id, component_id, chan, msg, shift_navigator_point->pathIndex, shift_navigator_point->pointIndex, shift_navigator_point->positionX, shift_navigator_point->positionY, shift_navigator_point->positionZ, shift_navigator_point->positionRoll, shift_navigator_point->positionPitch, shift_navigator_point->positionYaw, shift_navigator_point->duration, shift_navigator_point->yawBehaviour, shift_navigator_point->type);
}
...
static inline void mavlink_msg_shift_navigator_point_send(mavlink_channel_t chan, uint16_t pathIndex, uint16_t pointIndex, float positionX, float positionY, float positionZ, float positionRoll, float positionPitch, float positionYaw, float duration, uint8_t yawBehaviour, uint8_t type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SHIFT_NAVIGATOR_POINT_LEN];
    _mav_put_float(buf, 0, positionX);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_shift_navigator_point_send(chan, shift_navigator_point->pathIndex, shift_navigator_point->pointIndex, shift_navigator_point->positionX, shift_navigator_point->positionY, shift_navigator_point->positionZ, shift_navigator_point->positionRoll, shift_navigator_point->positionPitch, shift_navigator_point->positionYaw, shift_navigator_point->duration, shift_navigator_point->yawBehaviour, shift_navigator_point->type);
#else
 ...
 */
static inline void mavlink_msg_shift_navigator_point_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t pathIndex, uint16_t pointIndex, float positionX, float positionY, float positionZ, float positionRoll, float positionPitch, float positionYaw, float duration, uint8_t yawBehaviour, uint8_t type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
