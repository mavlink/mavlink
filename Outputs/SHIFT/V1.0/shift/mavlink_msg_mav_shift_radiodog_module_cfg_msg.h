...
#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_MODULE_CFG_MSG_LEN 19
#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_MODULE_CFG_MSG_MIN_LEN 19
#define MAVLINK_MSG_ID_510_LEN 19
#define MAVLINK_MSG_ID_510_MIN_LEN 19

#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_MODULE_CFG_MSG_CRC 108
#define MAVLINK_MSG_ID_510_CRC 108
...
static inline uint16_t mavlink_msg_mav_shift_radiodog_module_cfg_msg_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t moduleId, uint16_t newRadioId, uint8_t newModuleType, int32_t newXposition, int32_t newYposition, int32_t newZposition)
{
...
static inline void mavlink_msg_mav_shift_radiodog_module_cfg_msg_send(mavlink_channel_t chan, uint32_t moduleId, uint16_t newRadioId, uint8_t newModuleType, int32_t newXposition, int32_t newYposition, int32_t newZposition)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_MODULE_CFG_MSG_LEN];
    _mav_put_uint32_t(buf, 0, moduleId);
 ...
 */
static inline void mavlink_msg_mav_shift_radiodog_module_cfg_msg_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t moduleId, uint16_t newRadioId, uint8_t newModuleType, int32_t newXposition, int32_t newYposition, int32_t newZposition)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
