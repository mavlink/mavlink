...
#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG_LEN 23
#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG_MIN_LEN 23
#define MAVLINK_MSG_ID_503_LEN 23
#define MAVLINK_MSG_ID_503_MIN_LEN 23

#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG_CRC 57
#define MAVLINK_MSG_ID_503_CRC 57
...
#define MAVLINK_MESSAGE_INFO_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG { \
    ...
    {  { "t1", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_mav_shift_radiodog_ranging_request_data_msg_t, t1) }, \
         ...
         { "moduleId", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_mav_shift_radiodog_ranging_request_data_msg_t, moduleId) }, \
         { "radioId", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_mav_shift_radiodog_ranging_request_data_msg_t, radioId) }, \
         { "moduleType", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_mav_shift_radiodog_ranging_request_data_msg_t, moduleType) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG { \
...
static inline void mavlink_msg_mav_shift_radiodog_ranging_request_data_msg_send(mavlink_channel_t chan, uint32_t moduleId, uint16_t radioId, uint8_t moduleType, uint64_t t1, uint64_t t2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_RANGING_REQUEST_DATA_MSG_LEN];
    _mav_put_uint64_t(buf, 0, t1);
 ...
 */
static inline void mavlink_msg_mav_shift_radiodog_ranging_request_data_msg_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t moduleId, uint16_t radioId, uint8_t moduleType, uint64_t t1, uint64_t t2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
