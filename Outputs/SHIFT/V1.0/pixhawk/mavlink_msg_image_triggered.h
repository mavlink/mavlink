...
#define MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN 52
#define MAVLINK_MSG_ID_152_LEN 52
#define MAVLINK_MSG_ID_152_MIN_LEN 52
                               ...
                               uint64_t timestamp, uint32_t seq, float roll, float pitch, float yaw, float local_z, float lat, float lon, float alt, float ground_x, float ground_y, float ground_z)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
}
                                   ...
                                   uint64_t timestamp,uint32_t seq,float roll,float pitch,float yaw,float local_z,float lat,float lon,float alt,float ground_x,float ground_y,float ground_z)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_IMAGE_TRIGGERED;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
}
...
static inline void mavlink_msg_image_triggered_send(mavlink_channel_t chan, uint64_t timestamp, uint32_t seq, float roll, float pitch, float yaw, float local_z, float lat, float lon, float alt, float ground_x, float ground_y, float ground_z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMAGE_TRIGGERED, buf, MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
#else
    mavlink_image_triggered_t packet;
    packet.timestamp = timestamp;
    packet.seq = seq;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMAGE_TRIGGERED, (const char *)&packet, MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_image_triggered_send_struct(mavlink_channel_t chan, const mavlink_image_triggered_t* image_triggered)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_image_triggered_send(chan, image_triggered->timestamp, image_triggered->seq, image_triggered->roll, image_triggered->pitch, image_triggered->yaw, image_triggered->local_z, image_triggered->lat, image_triggered->lon, image_triggered->alt, image_triggered->ground_x, image_triggered->ground_y, image_triggered->ground_z);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMAGE_TRIGGERED, (const char *)image_triggered, MAVLINK_MSG_ID_IMAGE_TRIGGERED_MIN_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN? msg->len : MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN;
        memset(image_triggered, 0, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN);
    memcpy(image_triggered, _MAV_PAYLOAD(msg), len);
#endif
}
