...
#define MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN 18
                               ...
                               uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
}
                                   ...
                                   uint8_t target_system,uint8_t target_component,float x,float y,float z,float yaw)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
}
...
static inline void mavlink_msg_set_position_control_offset_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, buf, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
#else
    mavlink_set_position_control_offset_t packet;
    packet.x = x;
    packet.y = y;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, (const char *)&packet, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_set_position_control_offset_send_struct(mavlink_channel_t chan, const mavlink_set_position_control_offset_t* set_position_control_offset)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_set_position_control_offset_send(chan, set_position_control_offset->target_system, set_position_control_offset->target_component, set_position_control_offset->x, set_position_control_offset->y, set_position_control_offset->z, set_position_control_offset->yaw);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, (const char *)set_position_control_offset, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_MIN_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN? msg->len : MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN;
        memset(set_position_control_offset, 0, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN);
    memcpy(set_position_control_offset, _MAV_PAYLOAD(msg), len);
#endif
}
