...
#define MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN 18
#define MAVLINK_MSG_ID_170_LEN 18
#define MAVLINK_MSG_ID_170_MIN_LEN 18
                               ...
                               uint16_t id, float x, float y, float z, float yaw)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
}
                                   ...
                                   uint16_t id,float x,float y,float z,float yaw)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
}
...
static inline void mavlink_msg_position_control_setpoint_send(mavlink_channel_t chan, uint16_t id, float x, float y, float z, float yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, buf, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
#else
    mavlink_position_control_setpoint_t packet;
    packet.x = x;
    packet.y = y;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, (const char *)&packet, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_control_setpoint_send_struct(mavlink_channel_t chan, const mavlink_position_control_setpoint_t* position_control_setpoint)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_control_setpoint_send(chan, position_control_setpoint->id, position_control_setpoint->x, position_control_setpoint->y, position_control_setpoint->z, position_control_setpoint->yaw);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, (const char *)position_control_setpoint, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_MIN_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN? msg->len : MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN;
        memset(position_control_setpoint, 0, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN);
    memcpy(position_control_setpoint, _MAV_PAYLOAD(msg), len);
#endif
}
