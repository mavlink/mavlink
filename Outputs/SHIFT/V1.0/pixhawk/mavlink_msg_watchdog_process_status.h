...
#define MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN 12
                               ...
                               uint16_t watchdog_id, uint16_t process_id, uint8_t state, uint8_t muted, int32_t pid, uint16_t crashes)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_CRC);
}
                                   ...
                                   uint16_t watchdog_id,uint16_t process_id,uint8_t state,uint8_t muted,int32_t pid,uint16_t crashes)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_CRC);
}
...
static inline void mavlink_msg_watchdog_process_status_send(mavlink_channel_t chan, uint16_t watchdog_id, uint16_t process_id, uint8_t state, uint8_t muted, int32_t pid, uint16_t crashes)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS, buf, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_CRC);
#else
    mavlink_watchdog_process_status_t packet;
    packet.pid = pid;
    packet.watchdog_id = watchdog_id;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS, (const char *)&packet, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_watchdog_process_status_send_struct(mavlink_channel_t chan, const mavlink_watchdog_process_status_t* watchdog_process_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_watchdog_process_status_send(chan, watchdog_process_status->watchdog_id, watchdog_process_status->process_id, watchdog_process_status->state, watchdog_process_status->muted, watchdog_process_status->pid, watchdog_process_status->crashes);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS, (const char *)watchdog_process_status, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN? msg->len : MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN;
        memset(watchdog_process_status, 0, MAVLINK_MSG_ID_WATCHDOG_PROCESS_STATUS_LEN);
    memcpy(watchdog_process_status, _MAV_PAYLOAD(msg), len);
#endif
}
