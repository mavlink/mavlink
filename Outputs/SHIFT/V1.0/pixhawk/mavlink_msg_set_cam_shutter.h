...
#define MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN 11
                               ...
                               uint8_t cam_no, uint8_t cam_mode, uint8_t trigger_pin, uint16_t interval, uint16_t exposure, float gain)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
}
                                   ...
                                   uint8_t cam_no,uint8_t cam_mode,uint8_t trigger_pin,uint16_t interval,uint16_t exposure,float gain)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SET_CAM_SHUTTER;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
}
...
static inline void mavlink_msg_set_cam_shutter_send(mavlink_channel_t chan, uint8_t cam_no, uint8_t cam_mode, uint8_t trigger_pin, uint16_t interval, uint16_t exposure, float gain)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_CAM_SHUTTER, buf, MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
#else
    mavlink_set_cam_shutter_t packet;
    packet.gain = gain;
    packet.interval = interval;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_CAM_SHUTTER, (const char *)&packet, MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_set_cam_shutter_send_struct(mavlink_channel_t chan, const mavlink_set_cam_shutter_t* set_cam_shutter)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_set_cam_shutter_send(chan, set_cam_shutter->cam_no, set_cam_shutter->cam_mode, set_cam_shutter->trigger_pin, set_cam_shutter->interval, set_cam_shutter->exposure, set_cam_shutter->gain);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SET_CAM_SHUTTER, (const char *)set_cam_shutter, MAVLINK_MSG_ID_SET_CAM_SHUTTER_MIN_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN? msg->len : MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN;
        memset(set_cam_shutter, 0, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN);
    memcpy(set_cam_shutter, _MAV_PAYLOAD(msg), len);
#endif
}
