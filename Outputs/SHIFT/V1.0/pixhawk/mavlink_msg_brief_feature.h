...
#define MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN 53
#define MAVLINK_MSG_ID_195_LEN 53
#define MAVLINK_MSG_ID_195_MIN_LEN 53
                               ...
                               float x, float y, float z, uint8_t orientation_assignment, uint16_t size, uint16_t orientation, const uint8_t *descriptor, float response)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_CRC);
}
                                   ...
                                   float x,float y,float z,uint8_t orientation_assignment,uint16_t size,uint16_t orientation,const uint8_t *descriptor,float response)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_BRIEF_FEATURE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_CRC);
}
...
static inline void mavlink_msg_brief_feature_send(mavlink_channel_t chan, float x, float y, float z, uint8_t orientation_assignment, uint16_t size, uint16_t orientation, const uint8_t *descriptor, float response)
{
    ...
    _mav_put_uint8_t(buf, 20, orientation_assignment);
    _mav_put_uint8_t_array(buf, 21, descriptor, 32);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BRIEF_FEATURE, buf, MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_CRC);
#else
    mavlink_brief_feature_t packet;
    packet.x = x;
    packet.y = y;
    ...
    packet.orientation_assignment = orientation_assignment;
    mav_array_memcpy(packet.descriptor, descriptor, sizeof(uint8_t)*32);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BRIEF_FEATURE, (const char *)&packet, MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_brief_feature_send_struct(mavlink_channel_t chan, const mavlink_brief_feature_t* brief_feature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_brief_feature_send(chan, brief_feature->x, brief_feature->y, brief_feature->z, brief_feature->orientation_assignment, brief_feature->size, brief_feature->orientation, brief_feature->descriptor, brief_feature->response);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_BRIEF_FEATURE, (const char *)brief_feature, MAVLINK_MSG_ID_BRIEF_FEATURE_MIN_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN, MAVLINK_MSG_ID_BRIEF_FEATURE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_BRIEF_FEATURE_LEN? msg->len : MAVLINK_MSG_ID_BRIEF_FEATURE_LEN;
        memset(brief_feature, 0, MAVLINK_MSG_ID_BRIEF_FEATURE_LEN);
    memcpy(brief_feature, _MAV_PAYLOAD(msg), len);
#endif
}
