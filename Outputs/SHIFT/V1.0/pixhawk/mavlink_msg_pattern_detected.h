...
#define MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN 106
#define MAVLINK_MSG_ID_190_LEN 106
#define MAVLINK_MSG_ID_190_MIN_LEN 106
                               ...
                               uint8_t type, float confidence, const char *file, uint8_t detected)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_CRC);
}
                                   ...
                                   uint8_t type,float confidence,const char *file,uint8_t detected)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_PATTERN_DETECTED;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_CRC);
}
...
static inline void mavlink_msg_pattern_detected_send(mavlink_channel_t chan, uint8_t type, float confidence, const char *file, uint8_t detected)
{
    ...
    _mav_put_uint8_t(buf, 105, detected);
    _mav_put_char_array(buf, 5, file, 100);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PATTERN_DETECTED, buf, MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_CRC);
#else
    mavlink_pattern_detected_t packet;
    packet.confidence = confidence;
    packet.type = type;
    packet.detected = detected;
    mav_array_memcpy(packet.file, file, sizeof(char)*100);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PATTERN_DETECTED, (const char *)&packet, MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_pattern_detected_send_struct(mavlink_channel_t chan, const mavlink_pattern_detected_t* pattern_detected)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_pattern_detected_send(chan, pattern_detected->type, pattern_detected->confidence, pattern_detected->file, pattern_detected->detected);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_PATTERN_DETECTED, (const char *)pattern_detected, MAVLINK_MSG_ID_PATTERN_DETECTED_MIN_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN, MAVLINK_MSG_ID_PATTERN_DETECTED_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_PATTERN_DETECTED_LEN? msg->len : MAVLINK_MSG_ID_PATTERN_DETECTED_LEN;
        memset(pattern_detected, 0, MAVLINK_MSG_ID_PATTERN_DETECTED_LEN);
    memcpy(pattern_detected, _MAV_PAYLOAD(msg), len);
#endif
}
