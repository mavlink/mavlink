...
#define MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN 4
                               ...
                               uint16_t watchdog_id, uint16_t process_count)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
}
                                   ...
                                   uint16_t watchdog_id,uint16_t process_count)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
}
...
static inline void mavlink_msg_watchdog_heartbeat_send(mavlink_channel_t chan, uint16_t watchdog_id, uint16_t process_count)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, buf, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
#else
    mavlink_watchdog_heartbeat_t packet;
    packet.watchdog_id = watchdog_id;
    packet.process_count = process_count;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, (const char *)&packet, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_watchdog_heartbeat_send_struct(mavlink_channel_t chan, const mavlink_watchdog_heartbeat_t* watchdog_heartbeat)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_watchdog_heartbeat_send(chan, watchdog_heartbeat->watchdog_id, watchdog_heartbeat->process_count);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, (const char *)watchdog_heartbeat, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_MIN_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN? msg->len : MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN;
        memset(watchdog_heartbeat, 0, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN);
    memcpy(watchdog_heartbeat, _MAV_PAYLOAD(msg), len);
#endif
}
