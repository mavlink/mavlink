...
#define MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN 55
#define MAVLINK_MSG_ID_192_LEN 55
#define MAVLINK_MSG_ID_192_MIN_LEN 55
                               ...
                               uint8_t type, uint8_t color, uint8_t coordinate_system, uint16_t timeout, float xp1, float yp1, float zp1, float xp2, float yp2, float zp2, const char *name)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
}
                                   ...
                                   uint8_t type,uint8_t color,uint8_t coordinate_system,uint16_t timeout,float xp1,float yp1,float zp1,float xp2,float yp2,float zp2,const char *name)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
}
...
static inline void mavlink_msg_point_of_interest_connection_send(mavlink_channel_t chan, uint8_t type, uint8_t color, uint8_t coordinate_system, uint16_t timeout, float xp1, float yp1, float zp1, float xp2, float yp2, float zp2, const char *name)
{
    ...
    _mav_put_uint8_t(buf, 28, coordinate_system);
    _mav_put_char_array(buf, 29, name, 26);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, buf, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
#else
    mavlink_point_of_interest_connection_t packet;
    packet.xp1 = xp1;
    packet.yp1 = yp1;
    ...
    packet.coordinate_system = coordinate_system;
    mav_array_memcpy(packet.name, name, sizeof(char)*26);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, (const char *)&packet, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_point_of_interest_connection_send_struct(mavlink_channel_t chan, const mavlink_point_of_interest_connection_t* point_of_interest_connection)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_point_of_interest_connection_send(chan, point_of_interest_connection->type, point_of_interest_connection->color, point_of_interest_connection->coordinate_system, point_of_interest_connection->timeout, point_of_interest_connection->xp1, point_of_interest_connection->yp1, point_of_interest_connection->zp1, point_of_interest_connection->xp2, point_of_interest_connection->yp2, point_of_interest_connection->zp2, point_of_interest_connection->name);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, (const char *)point_of_interest_connection, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_MIN_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN? msg->len : MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN;
        memset(point_of_interest_connection, 0, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN);
    memcpy(point_of_interest_connection, _MAV_PAYLOAD(msg), len);
#endif
}
