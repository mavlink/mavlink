...
#define MAVLINK_MSG_ID_RAW_AUX_MIN_LEN 16
                               ...
                               uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int32_t baro)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_RAW_AUX_MIN_LEN, MAVLINK_MSG_ID_RAW_AUX_LEN, MAVLINK_MSG_ID_RAW_AUX_CRC);
}
                                   ...
                                   uint16_t adc1,uint16_t adc2,uint16_t adc3,uint16_t adc4,uint16_t vbat,int16_t temp,int32_t baro)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_RAW_AUX;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_RAW_AUX_MIN_LEN, MAVLINK_MSG_ID_RAW_AUX_LEN, MAVLINK_MSG_ID_RAW_AUX_CRC);
}
...
static inline void mavlink_msg_raw_aux_send(mavlink_channel_t chan, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int32_t baro)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_AUX, buf, MAVLINK_MSG_ID_RAW_AUX_MIN_LEN, MAVLINK_MSG_ID_RAW_AUX_LEN, MAVLINK_MSG_ID_RAW_AUX_CRC);
#else
    mavlink_raw_aux_t packet;
    packet.baro = baro;
    packet.adc1 = adc1;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_AUX, (const char *)&packet, MAVLINK_MSG_ID_RAW_AUX_MIN_LEN, MAVLINK_MSG_ID_RAW_AUX_LEN, MAVLINK_MSG_ID_RAW_AUX_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_raw_aux_send_struct(mavlink_channel_t chan, const mavlink_raw_aux_t* raw_aux)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_raw_aux_send(chan, raw_aux->adc1, raw_aux->adc2, raw_aux->adc3, raw_aux->adc4, raw_aux->vbat, raw_aux->temp, raw_aux->baro);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_AUX, (const char *)raw_aux, MAVLINK_MSG_ID_RAW_AUX_MIN_LEN, MAVLINK_MSG_ID_RAW_AUX_LEN, MAVLINK_MSG_ID_RAW_AUX_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_RAW_AUX_LEN? msg->len : MAVLINK_MSG_ID_RAW_AUX_LEN;
        memset(raw_aux, 0, MAVLINK_MSG_ID_RAW_AUX_LEN);
    memcpy(raw_aux, _MAV_PAYLOAD(msg), len);
#endif
}
