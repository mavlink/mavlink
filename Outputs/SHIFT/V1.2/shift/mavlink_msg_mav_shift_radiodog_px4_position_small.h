...
typedef struct __mavlink_mav_shift_radiodog_px4_position_small_t {
 ...
 uint16_t radioId; /*< The new RadioDog Radio ID (Sending module)*/
 uint8_t moduleType; /*< The new Module Type*/
...
#define MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_PX4_POSITION_SMALL_CRC 54
#define MAVLINK_MSG_ID_520_CRC 54
...
#define MAVLINK_MESSAGE_INFO_MAV_SHIFT_RADIODOG_PX4_POSITION_SMALL { \
    ...
    {  { "moduleId", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_mav_shift_radiodog_px4_position_small_t, moduleId) }, \
         ...
         { "radioId", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_mav_shift_radiodog_px4_position_small_t, radioId) }, \
         { "moduleType", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_mav_shift_radiodog_px4_position_small_t, moduleType) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAV_SHIFT_RADIODOG_PX4_POSITION_SMALL { \
 ...
 * @param radioId The new RadioDog Radio ID (Sending module)
...
static inline uint16_t mavlink_msg_mav_shift_radiodog_px4_position_small_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t moduleId, uint16_t radioId, uint8_t moduleType, uint32_t positionTimeStamp, int32_t Xposition, int32_t Yposition, int32_t Zposition)
{
...
{
    return mavlink_msg_mav_shift_radiodog_px4_position_small_pack(system_id, component_id, msg, mav_shift_radiodog_px4_position_small->moduleId, mav_shift_radiodog_px4_position_small->radioId, mav_shift_radiodog_px4_position_small->moduleType, mav_shift_radiodog_px4_position_small->positionTimeStamp, mav_shift_radiodog_px4_position_small->Xposition, mav_shift_radiodog_px4_position_small->Yposition, mav_shift_radiodog_px4_position_small->Zposition);
}
...
{
    return mavlink_msg_mav_shift_radiodog_px4_position_small_pack_chan(system_id, component_id, chan, msg, mav_shift_radiodog_px4_position_small->moduleId, mav_shift_radiodog_px4_position_small->radioId, mav_shift_radiodog_px4_position_small->moduleType, mav_shift_radiodog_px4_position_small->positionTimeStamp, mav_shift_radiodog_px4_position_small->Xposition, mav_shift_radiodog_px4_position_small->Yposition, mav_shift_radiodog_px4_position_small->Zposition);
}
...
static inline void mavlink_msg_mav_shift_radiodog_px4_position_small_send(mavlink_channel_t chan, uint32_t moduleId, uint16_t radioId, uint8_t moduleType, uint32_t positionTimeStamp, int32_t Xposition, int32_t Yposition, int32_t Zposition)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAV_SHIFT_RADIODOG_PX4_POSITION_SMALL_LEN];
    _mav_put_uint32_t(buf, 0, moduleId);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mav_shift_radiodog_px4_position_small_send(chan, mav_shift_radiodog_px4_position_small->moduleId, mav_shift_radiodog_px4_position_small->radioId, mav_shift_radiodog_px4_position_small->moduleType, mav_shift_radiodog_px4_position_small->positionTimeStamp, mav_shift_radiodog_px4_position_small->Xposition, mav_shift_radiodog_px4_position_small->Yposition, mav_shift_radiodog_px4_position_small->Zposition);
#else
 ...
 */
static inline void mavlink_msg_mav_shift_radiodog_px4_position_small_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t moduleId, uint16_t radioId, uint8_t moduleType, uint32_t positionTimeStamp, int32_t Xposition, int32_t Yposition, int32_t Zposition)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field radioId from mav_shift_radiodog_px4_position_small message
 *
 * @return The new RadioDog Radio ID (Sending module)
 */
static inline uint16_t mavlink_msg_mav_shift_radiodog_px4_position_small_get_radioId(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  20);
}

/**
 * @brief Get field moduleType from mav_shift_radiodog_px4_position_small message
 *
 * @return The new Module Type
 */
static inline uint8_t mavlink_msg_mav_shift_radiodog_px4_position_small_get_moduleType(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mav_shift_radiodog_px4_position_small_decode(const mavlink_message_t* msg, mavlink_mav_shift_radiodog_px4_position_small_t* mav_shift_radiodog_px4_position_small)
{
    ...
    mav_shift_radiodog_px4_position_small->radioId = mavlink_msg_mav_shift_radiodog_px4_position_small_get_radioId(msg);
    mav_shift_radiodog_px4_position_small->moduleType = mavlink_msg_mav_shift_radiodog_px4_position_small_get_moduleType(msg);
#else
