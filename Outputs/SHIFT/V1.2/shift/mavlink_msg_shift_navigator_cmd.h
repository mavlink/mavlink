...
typedef struct __mavlink_shift_navigator_cmd_t {
 ...
 uint32_t path_id; /*< ID of the path which is affected by this command*/
 uint8_t cmd; /*< The command itself. Using ENUM: SHIFT_NAVIGATOR_CMD_ENUM*/
}) mavlink_shift_navigator_cmd_t;

#define MAVLINK_MSG_ID_SHIFT_NAVIGATOR_CMD_LEN 13
#define MAVLINK_MSG_ID_SHIFT_NAVIGATOR_CMD_MIN_LEN 13
#define MAVLINK_MSG_ID_551_LEN 13
#define MAVLINK_MSG_ID_551_MIN_LEN 13

#define MAVLINK_MSG_ID_SHIFT_NAVIGATOR_CMD_CRC 214
#define MAVLINK_MSG_ID_551_CRC 214
...
#define MAVLINK_MESSAGE_INFO_SHIFT_NAVIGATOR_CMD { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_shift_navigator_cmd_t, time_usec) }, \
         { "path_id", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_shift_navigator_cmd_t, path_id) }, \
         { "cmd", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_shift_navigator_cmd_t, cmd) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SHIFT_NAVIGATOR_CMD { \
 ...
 * @param path_id ID of the path which is affected by this command
...
static inline uint16_t mavlink_msg_shift_navigator_cmd_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint32_t path_id, uint8_t cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SHIFT_NAVIGATOR_CMD_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
    _mav_put_uint32_t(buf, 8, path_id);
...
{
    return mavlink_msg_shift_navigator_cmd_pack(system_id, component_id, msg, shift_navigator_cmd->time_usec, shift_navigator_cmd->path_id, shift_navigator_cmd->cmd);
}
...
{
    return mavlink_msg_shift_navigator_cmd_pack_chan(system_id, component_id, chan, msg, shift_navigator_cmd->time_usec, shift_navigator_cmd->path_id, shift_navigator_cmd->cmd);
}
...
static inline void mavlink_msg_shift_navigator_cmd_send(mavlink_channel_t chan, uint64_t time_usec, uint32_t path_id, uint8_t cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SHIFT_NAVIGATOR_CMD_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_shift_navigator_cmd_send(chan, shift_navigator_cmd->time_usec, shift_navigator_cmd->path_id, shift_navigator_cmd->cmd);
#else
 ...
 */
static inline void mavlink_msg_shift_navigator_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint32_t path_id, uint8_t cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field path_id from shift_navigator_cmd message
 *
 * @return ID of the path which is affected by this command
 */
static inline uint32_t mavlink_msg_shift_navigator_cmd_get_path_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_shift_navigator_cmd_decode(const mavlink_message_t* msg, mavlink_shift_navigator_cmd_t* shift_navigator_cmd)
{
    ...
    shift_navigator_cmd->path_id = mavlink_msg_shift_navigator_cmd_get_path_id(msg);
