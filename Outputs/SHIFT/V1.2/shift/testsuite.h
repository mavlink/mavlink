...
static void mavlink_test_shift_navigator_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_shift_navigator_cmd_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.path_id = packet_in.path_id;
    ...
    mavlink_msg_shift_navigator_cmd_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_navigator_cmd_pack(system_id, component_id, &msg , packet1.time_usec , packet1.path_id , packet1.cmd );
    mavlink_msg_shift_navigator_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_navigator_cmd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.path_id , packet1.cmd );
    mavlink_msg_shift_navigator_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_shift_navigator_cmd_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_navigator_cmd_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.path_id , packet1.cmd );
    mavlink_msg_shift_navigator_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_shift_navigator_point(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_shift_navigator_point_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,18691,18795,101,168
    };
...
static void mavlink_test_shift_navigator_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SHIFT_NAVIGATOR_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_shift_navigator_status_t packet_in = {
        17235,17339,17,84,151,218,29
    };
    mavlink_shift_navigator_status_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SHIFT_NAVIGATOR_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SHIFT_NAVIGATOR_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_navigator_status_encode(system_id, component_id, &msg, &packet1);
...
static void mavlink_test_shift_system_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_shift_system_cmd_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_system_cmd_pack(system_id, component_id, &msg , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.cmd4 , packet1.cmd5 , packet1.cmd6 , packet1.type );
    mavlink_msg_shift_system_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_system_cmd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.cmd4 , packet1.cmd5 , packet1.cmd6 , packet1.type );
    mavlink_msg_shift_system_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_shift_system_cmd_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_shift_system_cmd_send(MAVLINK_COMM_1 , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.cmd4 , packet1.cmd5 , packet1.cmd6 , packet1.type );
    mavlink_msg_shift_system_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_shift(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_shift_navigator_status(system_id, component_id, last_msg);
