...
typedef enum SHIFT_NAVIGATOR_POINT_TYPE_ENUM
{
   ...
   ARC=1, /* The point is the center of an ARC | */
   SHIFT_NAVIGATOR_POINT_TYPE_ENUM_ENUM_END=2, /*  | */
