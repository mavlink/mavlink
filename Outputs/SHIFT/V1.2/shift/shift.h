/** @file
 *  @brief MAVLink comm protocol generated from shift.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_SHIFT_H
#define MAVLINK_SHIFT_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_SHIFT.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
/** @brief CMD for the navigator */
#ifndef HAVE_ENUM_SHIFT_NAVIGATOR_CMD_ENUM
#define HAVE_ENUM_SHIFT_NAVIGATOR_CMD_ENUM
typedef enum SHIFT_NAVIGATOR_CMD_ENUM
{
   NAVIGATOR_PAUSE=0, /* Pause the navigator | */
   NAVIGATOR_START=1, /* Start the navigator | */
   NAVIGATOR_REVERSE=2, /* Reverse start the navigator | */
   NAVIGATOR_PRELOAD_PATH=3, /* Preload a path into the navigator | */
   NAVIGATOR_RESET_PATH=4, /* Reset the current loaded path in the navigator | */
   SHIFT_NAVIGATOR_CMD_ENUM_ENUM_END=5, /*  | */
} SHIFT_NAVIGATOR_CMD_ENUM;
#endif
...
{
   FACE_TRAVEL_DIRECTION=0, /* Look at the point we are flying to | */
   FACE_TRAVEL_DIRECTION_INVERTED=1, /* Look away from the point we are flying to | */
   FIXED_AT_YAW=2, /* Keep looking at the yaw in the point that we are traveling to | */
   INTERPOLATE=3, /* Interpolate from previous point yaw to the next point's yaw' | */
   SHIFT_NAVIGATOR_YAW_BEHAVIOUR_ENUM_ENUM_END=4, /*  | */
...
{
   POINT=0, /* The point is just a point | */
   ARC_CW=1, /* The point is the center of an ARC | */
   ARC_CCW=2, /* The point is the center of an ARC | */
   SHIFT_NAVIGATOR_POINT_TYPE_ENUM_ENUM_END=3, /*  | */
...
#include "./mavlink_msg_shift_navigator_status.h"
