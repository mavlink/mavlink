...
#define MAVLINK_MSG_ID_SHIFT_SYSTEM_CMD_LEN 14
#define MAVLINK_MSG_ID_SHIFT_SYSTEM_CMD_MIN_LEN 14
#define MAVLINK_MSG_ID_570_LEN 14
#define MAVLINK_MSG_ID_570_MIN_LEN 14

#define MAVLINK_MSG_ID_SHIFT_SYSTEM_CMD_CRC 39
#define MAVLINK_MSG_ID_570_CRC 39
...
#define MAVLINK_MESSAGE_INFO_SHIFT_SYSTEM_CMD { \
    ...
    {  { "cmd1", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_shift_system_cmd_t, cmd1) }, \
         ...
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_shift_system_cmd_t, target_system) }, \
         { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 13, offsetof(mavlink_shift_system_cmd_t, type) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SHIFT_SYSTEM_CMD { \
...
static inline uint16_t mavlink_msg_shift_system_cmd_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint16_t cmd1, uint16_t cmd2, uint16_t cmd3, uint16_t cmd4, uint16_t cmd5, uint16_t cmd6, uint8_t type)
{
...
{
    return mavlink_msg_shift_system_cmd_pack(system_id, component_id, msg, shift_system_cmd->target_system, shift_system_cmd->cmd1, shift_system_cmd->cmd2, shift_system_cmd->cmd3, shift_system_cmd->cmd4, shift_system_cmd->cmd5, shift_system_cmd->cmd6, shift_system_cmd->type);
}
...
{
    return mavlink_msg_shift_system_cmd_pack_chan(system_id, component_id, chan, msg, shift_system_cmd->target_system, shift_system_cmd->cmd1, shift_system_cmd->cmd2, shift_system_cmd->cmd3, shift_system_cmd->cmd4, shift_system_cmd->cmd5, shift_system_cmd->cmd6, shift_system_cmd->type);
}
...
static inline void mavlink_msg_shift_system_cmd_send(mavlink_channel_t chan, uint8_t target_system, uint16_t cmd1, uint16_t cmd2, uint16_t cmd3, uint16_t cmd4, uint16_t cmd5, uint16_t cmd6, uint8_t type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SHIFT_SYSTEM_CMD_LEN];
    _mav_put_uint16_t(buf, 0, cmd1);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_shift_system_cmd_send(chan, shift_system_cmd->target_system, shift_system_cmd->cmd1, shift_system_cmd->cmd2, shift_system_cmd->cmd3, shift_system_cmd->cmd4, shift_system_cmd->cmd5, shift_system_cmd->cmd6, shift_system_cmd->type);
#else
 ...
 */
static inline void mavlink_msg_shift_system_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint16_t cmd1, uint16_t cmd2, uint16_t cmd3, uint16_t cmd4, uint16_t cmd5, uint16_t cmd6, uint8_t type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_system from shift_system_cmd message
 *
 * @return System ID
 */
static inline uint8_t mavlink_msg_shift_system_cmd_get_target_system(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_shift_system_cmd_decode(const mavlink_message_t* msg, mavlink_shift_system_cmd_t* shift_system_cmd)
{
    ...
    shift_system_cmd->target_system = mavlink_msg_shift_system_cmd_get_target_system(msg);
