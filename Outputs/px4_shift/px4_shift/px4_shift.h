...
typedef enum NAVIGATOR_CMD
{
   ...
   NAVIGATOR_CMD_REQUEST_START_SIM=9, /* Start the path in simulation mode | */
   NAVIGATOR_CMD_ENUM_END=10, /*  | */
} NAVIGATOR_CMD;
#endif
